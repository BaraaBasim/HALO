...
def run(
    ...
    if swarm_parameters == None:
        ...
        x = torch.tensor([[  0.00000,   0.00000,  62.75631, 700.00000],
        [  0.00000, 700.00000,   0.00000, 168.30038],
        [  0.00000,   0.00000, 700.00000, 422.42365],
        [  0.00000, 668.95422,   0.00000,   0.00000]], device='cuda:0')
        # load patch
        ############################ 
