...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default="/home/ps/Baraa/physics_based_image_generation_model_matlab_script/HALOAttack/v0/checkpoints/yolov5s.pt", help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default="/home/ps/Baraa/physics_based_image_generation_model_matlab_script/HALOAttack/v0/yolov5/data/adv_training.yaml", help='dataset.yaml path')
